...
if __name__ == "__main__":
    ...
    ids_file.close()
    confidences = compute_cooccur_and_entropy(sys.argv[1], ft, minsup, minconf)[0]

    for antecedente in confidences:
        lista = confidences[antecedente]
        for consequente in lista:
            print m[antecedente], m[consequente], lista[consequente] * ft[antecedente], lista[consequente]
